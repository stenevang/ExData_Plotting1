...
plot(EPCdata$DateTime, EPCdata$Global_active_power, ylab="Global Active Power (kilowatts)", xlab="", type="n")
lines(EPCdata$DateTime, EPCdata$Global_active_power)

plot(EPCdata$DateTime, EPCdata$Voltage, ylab="Voltage", xlab="datetime", type="n")
...
legend("topright", bty = "n", legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col=c("black","red","blue"), lwd=1, lty=1)

plot(EPCdata$DateTime, EPCdata$Global_reactive_power, ylab="Global_reactive_power", xlab="datetime", type="n")
